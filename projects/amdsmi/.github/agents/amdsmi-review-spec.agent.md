...
tools: read/readFile, search/textSearch, search/fileSearch, search/listDirectory, search/usages, execute/runInTerminal, jira-atlassian-amd-hub, confluence-atlassian-cloud
